...
- images (dict; optional): The images array. images has the following type: list of dicts containing keys 'src', 'thumbnail', 'srcset', 'caption', 'thumbnailWidth', 'thumbnailHeight', 'isSelected', 'customdata'.
Those keys have the following types:
  - src (string; required)
  ...
  - customdata (number; optional)"""
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, selectedImages=Component.UNDEFINED, galleryHeaderStyle=Component.UNDEFINED, images=Component.UNDEFINED, **kwargs):
