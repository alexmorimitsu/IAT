...
def load_batch(confirm_load, opacity, marker_size, order_by, label_nclicks, reset_graphs,
               project_name, batch_name, prev_selection, check_save, check_discard, new_label, imageselector_images):
    global fig, df, order_images_vals, default_features, manual_features, options_images, loaded_project
