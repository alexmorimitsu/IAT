...
def print_batches(dataframes_path, map_id_to_batch, project_name):
    for key in map_id_to_batch.keys():
        csv_name = map_id_to_batch[key] + '.csv'
...
thumbnails_path = 'assets/' + project_name + '/images/'
...
path_to_images = join(images_path, map_id_to_batch[batch_id], 'images/')
path_to_thumbnails = join(thumbnails_path, map_id_to_batch[batch_id], 'images/')
path_to_csv = dataframes_path + map_id_to_batch[batch_id] + '.csv'
